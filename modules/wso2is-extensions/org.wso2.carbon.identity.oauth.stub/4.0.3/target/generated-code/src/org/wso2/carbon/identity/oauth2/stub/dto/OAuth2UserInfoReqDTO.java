 ...
 */
            ...
            /**
            *  OAuth2UserInfoReqDTO bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":OAuth2UserInfoReqDTO",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "OAuth2UserInfoReqDTO",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static OAuth2UserInfoReqDTO parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OAuth2UserInfoReqDTO object =
                new OAuth2UserInfoReqDTO();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OAuth2UserInfoReqDTO".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OAuth2UserInfoReqDTO)org.wso2.carbon.identity.oauth2.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
