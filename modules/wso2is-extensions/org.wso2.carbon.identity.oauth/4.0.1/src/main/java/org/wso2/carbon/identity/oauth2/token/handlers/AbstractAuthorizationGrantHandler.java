...
public abstract class AbstractAuthorizationGrantHandler implements AuthorizationGrantHandler {
    ...
    public boolean validateScope(OAuthTokenReqMessageContext tokReqMsgCtx)
		...
		if (scopeValidationCallback.isValidScope()) {
			...
			if (scopeValidationCallback.getApprovedScope() == null
					|| scopeValidationCallback.getApprovedScope().length == 0) {
				tokReqMsgCtx.setScope(scopeValidationCallback.getRequestedScope());
			} else {
