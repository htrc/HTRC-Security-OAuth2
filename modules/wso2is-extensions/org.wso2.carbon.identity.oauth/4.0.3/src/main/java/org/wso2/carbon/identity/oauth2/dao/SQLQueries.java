...
public class SQLQueries {
    ...
    public static final String VALIDATE_BEARER_TOKEN = "SELECT AUTHZ_USER, " +
            "TOKEN_SCOPE, TIME_CREATED, CONSUMER_KEY, VALIDITY_PERIOD FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "WHERE ACCESS_TOKEN = ?";
    ...
    public static final String FIND_CONSUMER_APP_NAME = "SELECT APP_NAME FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?";
}
