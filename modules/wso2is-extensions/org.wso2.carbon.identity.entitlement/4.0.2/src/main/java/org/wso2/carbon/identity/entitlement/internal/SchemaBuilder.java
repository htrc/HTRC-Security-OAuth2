...
public class SchemaBuilder implements Runnable {
    ...
    public void run() {
        try {
            ...
            configHolder.getCachingProperties().setProperty(EntitlementExtensionBuilder.PDP_SCHEMA_VALIDATION, "false");
    ...
    public void buildPolicySchema() throws SAXException {
        ...
        if (!"true".equalsIgnoreCase((String) configHolder.getCachingProperties().get(
