...
public class PolicyMetaDataBuilder {
        ...
        if(attributeValueDTOs != null){
            for(AttributeValueDTO attributeValueDTO : attributeValueDTOs){
                properties.setProperty(EntitlementConstants.POLICY_META_DATA + attributeElementNo,
                       ...
                       attributeValueDTO.getAttributeValue() + EntitlementConstants.ATTRIBUTE_SEPARATOR +
            ...
            for (int attributeElementNo = 0; attributeElementNo < properties.size();){
                ...
                if(attributeList != null && attributeList.get(0) != null){
                    ...
                    if(attributeData.length == EntitlementConstants.POLICY_META_DATA_ARRAY_LENGTH){
                        ...
                        attributeValueDTO.setAttributeValue(attributeData[1]);
        ...
        if (omElement != null) {
            ...
            while(iterator1.hasNext()){
                ...
                if(version == XACMLConstants.XACML_VERSION_3_0){
                    createMetaDataFromXACML3TargetElement(targetElement, attributeValueDTOs);
                } else {
     ...
     * @return list of AttributeValueDTO object which holds the policy meta data in String format
     */
    public List<AttributeValueDTO> createMetaDataFromXACML3TargetElement(OMElement omElement,
                                                        List<AttributeValueDTO> attributeValueDTOs){
        ...
        if(omElement != null){
            ...
            while(iterator3.hasNext()){
                ...
                if(attributeElement != null){
                    AttributeValueDTO attributeValueDTO = new AttributeValueDTO();
                    attributeValueDTO.setAttributeValue(attributeElement.getText());
     ...
     * @return AttributeValueDTO object which holds the policy meta data in String format
     */
    public List<AttributeValueDTO> createMetaDataFromXACML3MatchElement(OMElement omElement){
        ...
        if(omElement != null){
            ...
            while(iterator3.hasNext()){
                ...
                if(attributeElement != null){
                    ...
                    attributeValueDTO.setAttributeId(attributeId);
                    attributeValueDTO.setAttributeDataType(dataType);
                    attributeValueDTO.setAttributeType(category);
                    attributeValueDTOs.add(attributeValueDTO);
                }
            }
        }
            ...
            while(iterator1.hasNext()){
                ...
                if(attributeDesignator != null){
                    ...
                    if(attributeValues == null){
                        ...
                        attributeValueDTO.setAttributeValue(EntitlementConstants.SEARCH_WARNING_MESSAGE1 +
                        ...
                        AttributeValueDTO attributeValueDTO = new AttributeValueDTO();
                        attributeValueDTO.setAttributeType(EntitlementConstants.UNKNOWN);
                        attributeValueDTO.setAttributeValue(EntitlementConstants.SEARCH_WARNING_MESSAGE2 +
                                                    " for " + EntitlementConstants.RESOURCE_ELEMENT +
                                                    " Designator Element ");
            ...
            while(iterator5.hasNext()){
                ...
                if(attributeSelector != null){
                    ...
                    if(attributeValues == null){
                        AttributeValueDTO attributeValueDTO = new AttributeValueDTO();
                        attributeValueDTO.setAttributeType(EntitlementConstants.UNKNOWN);
                        attributeValueDTO.setAttributeValue(EntitlementConstants.SEARCH_WARNING_MESSAGE3);
            ...
            if(iterator6.hasNext()) {
                ...
                if(attributeValues == null){
                    ...
                    for(String values : attributeValues){
                        AttributeValueDTO attributeValueDTO = new AttributeValueDTO();
                        attributeValueDTO.setAttributeValue(values);
                        ...
                        while(iterator8.hasNext()){
                            ...
                            if(version == XACMLConstants.XACML_VERSION_3_0){
                                searchXACML3Designator(applyElement, attributeValueDTO);
                            } else {
     ...
     * @return list of AttributeValueDTO object which holds the policy meta data in String format
     */
    public List<AttributeValueDTO> createMetaDataFromXACML3ApplyElement(OMElement omElement,
                                                      List<AttributeValueDTO> attributeValueDTOs) {
        ...
        if(omElement != null){
            ...
            while(iterator7.hasNext()){
                OMElement applyElement = (OMElement)iterator7.next();
                createMetaDataFromXACML3ApplyElement(applyElement,attributeValueDTOs);
            }
        }
        return attributeValueDTOs;
    }
     ...
     * @return   AttributeValueDTO object which holds the policy meta data in String format
     */
    public AttributeValueDTO searchXACML3Designator(OMElement omElement,
                                                        AttributeValueDTO attributeValueDTO) {
    ...
    public List<AttributeValueDTO> createMetaDataFromConditionElement(OMElement omElement,
        ...
        if(iterator.hasNext()){
            if(version == XACMLConstants.XACML_VERSION_3_0){
                createMetaDataFromXACML3ApplyElement(omElement, attributeValueDTOs);                
            } else {
            ...
            AttributeValueDTO attributeValueDTO = new AttributeValueDTO();
            attributeValueDTO.setAttributeType(EntitlementConstants.UNKNOWN);
            attributeValueDTO.setAttributeValue(EntitlementConstants.SEARCH_WARNING_MESSAGE4);
        }
