...
<%
    ...
    System.out.println("AAAAAAAAAAAAAAAAAA  " + maxUserRowString) ;
    System.out.println("CCCCCCCCCCCCCCCCCCCCCCC  " + maxResourceRowString);
    System.out.println("Category   " + dynamicCategory);
    System.out.println("function1   " + request.getParameter("resourceRuleFunction_0"));
    System.out.println("function2   " + request.getParameter("resourceRuleFunction_4"));
    ...
    if(policyId != null && policyId.trim().length() > 0){
        ...
        for(int rowNumber = 0; rowNumber < maxRows + 1; rowNumber++){
            ...
            System.out.println("userRuleAttributeValue_" + rowNumber + "        "  + userAttributeValue);
            ...
            System.out.println("resourceRuleValue_" + rowNumber + "        "  + resourceValue);
            } else {
