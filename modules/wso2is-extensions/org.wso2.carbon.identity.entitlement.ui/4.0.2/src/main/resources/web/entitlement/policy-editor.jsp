...
<script type="text/javascript">
    ...
    function createNewTargetRow(value) {
        if (value == "AND" || value == "OR"){
            ...
            jQuery('#multipleTargetTable > tbody:last').append('<tr data-value="'+ index +'"><td style="padding-left:0px !important;padding-right:0px !important"><select id="targetCategory_'  + index + '" name="targetCategory_'  + index + '" class="leftCol-small"> <%for (String category : categories) { if(currentCategory != null && category.equals(currentCategory)){%> <option value="<%=category%>" selected="selected"><%=currentCategory%> </option> <%} else {%> <option value="<%=category%>"><%=category%> </option> <%} }%></select></td>' +
                ...
                '<td style="padding-left:0px !important;padding-right:0px !important"><select id="targetCombineFunctions_'  + index + '" name="targetCombineFunctions_'  + index + '" class="newTargetRow leftCol-small" onchange="createNewTargetRow(this.options[this.selectedIndex].value)"><%for (String combineFunction : combineFunctions) {if (currentCombineFunction != null && combineFunction.equals(currentCombineFunction)) {%><option value="<%=combineFunction%>" selected="selected"><%=combineFunction%></option><%} else {%><option value="<%=combineFunction%>"><%=combineFunction%></option><%}}%></select></td>' +
    ...
    function createNewRuleTargetRow(value) {
        if (value == "AND" || value == "OR"){
            ...
            var index = parseInt(rowIndex, 10) + 1;
            jQuery('#multipleRuleTargetTable > tbody:last').append('<tr data-value="'+ index +'"><td style="padding-left:0px !important;padding-right:0px !important"><select id="ruleTargetCategory_'  + index + '" name="ruleTargetCategory_'  + index + '" class="leftCol-small"> <%for (String category : categories) { if(currentRuleTargetCategory != null && category.equals(currentRuleTargetCategory)){%> <option value="<%=category%>" selected="selected"><%=currentCategory%> </option> <%} else {%> <option value="<%=category%>"><%=category%> </option> <%} }%></select></td>' +
    ...
    function createNewRuleRow(value) {
        if (value == "AND" || value == "OR"){
            ...
            var index = parseInt(rowIndex, 10) + 1;
            jQuery('#multipleRuleTable > tbody:last').append('<tr data-value="'+ index +'"><td style="padding-left:0px !important;padding-right:0px !important"><select id="ruleCategory_'  + index + '" name="ruleCategory_'  + index + '" class="leftCol-small"> <%for (String category : categories) { if(currentRuleCategory != null && category.equals(currentRuleCategory)){%> <option value="<%=category%>" selected="selected"><%=category%> </option> <%} else {%> <option value="<%=category%>"><%=category%> </option> <%} }%></select></td>' +
                    ...
                    <td>
                        <table id="multipleTargetTable" name="multipleTargetTable" class="normal"
                            ...
                            <tr data-value="0">
                                ...
                                <td style="padding-left:0px !important;padding-right:0px !important">
                                    <select id="targetPreFunction_0" name="targetPreFunction_0" class="leftCol-small">
                                        <%
                                ...
                                <td style="padding-left:0px !important;padding-right:0px !important">
                                    <select id="targetCombineFunctions_0" name="targetCombineFunctions_0"
                                            class="newTargetRow leftCol-small" onchange="createNewTargetRow(this.options[this.selectedIndex].value)">
                                        <%
                            ...
                            <tr data-value="0">
                                ...
                                <td style="padding-left:0px !important;padding-right:0px !important">
                                    <select id="ruleTargetCombineFunctions_0" name="ruleTargetCombineFunctions_0"
                                            class="newRuleTargetRow leftCol-small" onchange="createNewRuleTargetRow(this.options[this.selectedIndex].value)">
                                        <%
                                            for (String combineFunction : combineFunctions) {
                            ...
                            <tr data-value="0">
                                ...
                                <td style="padding-left:0px !important;padding-right:0px !important">
                                    <select id="ruleCombineFunctions_0" name="ruleCombineFunctions_0"
                                            class="newRuleRow leftCol-small" onchange="createNewRuleRow(this.options[this.selectedIndex].value)">
                                        <%
                                            for (String combineFunction : combineFunctions) {
...
%>
                    ...
                    <tr>                       
                        <td colspan='5'>
                            ...
                            <td></td><td></td><td></td><td></td<td>Obligation Id</td>
                            <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>Attribute Expression</td>
                            <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                            <td>Assignment Id</td><td></td><td></td>
                            </table>
                        </td>
                    </tr>
                    <tr>
...
<tr>
    ...
    <div class="toggle_container" id="newObligationLinkRow">
        ...
        <td>Obligation Type</td>
        <td></td><td></td><td></td><td></td><td>Obligation Id</td>
        <td></td><td></td><td></td><td></td><td></td><td>Effect</td>
        <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>Attribute Expression</td>
        <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
        <td>Assignment Id</td><td></td><td></td>
        </table>
