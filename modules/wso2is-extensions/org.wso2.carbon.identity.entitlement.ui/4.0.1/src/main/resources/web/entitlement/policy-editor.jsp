...
<script type="text/javascript">
    ...
    function createNewRuleObligationRow() {
        var index = jQuery('#obligationRuleTable tr').length;
        jQuery('#obligationRuleTable > tbody:last').append('<tr>' +
            '<td style="padding-left:0px !important;padding-right:0px !important"><select id="obligationRuleType_' + index +'" name="obligationRuleType_' + index +'" class="leftCol-small"><%for (String type : obligationTypes) {if (currentRuleObligationType != null && type.equals(currentRuleObligationType)) {%><option value="<%=type%>" selected="selected"><%=type%></option><%} else {%><option value="<%=type%>"><%=type%></option><%}}%></select></td>' +
            ...
            '<td><a onclick="createNewRuleObligationRow();" style="background-image:url(images/add.gif);float:none" type="button" class="icon-link"></a></td>' +
            '<td><a onclick="removeRow(this)" style="background-image:url(images/delete.gif);" type="button" class="icon-link"></a></td>' +
            '</tr>');
    }

    function createNewObligationRow() {
        var  index = jQuery('#obligationTable tr').length;
        jQuery('#obligationTable > tbody:last').append('<tr>' +
            '<td style="padding-left:0px !important;padding-right:0px !important"><select id="obligationType_' + index +'" name="obligationType_' + index +'" class="leftCol-small"><%for (String type : obligationTypes) {if (currentObligationType != null && type.equals(currentObligationType)) {%><option value="<%=type%>" selected="selected"><%=type%></option><%} else {%><option value="<%=type%>"><%=type%></option><%}}%></select></td>' +
            ...
            '<td><a onclick="createNewObligationRow();" style="background-image:url(images/add.gif);float:none" type="button" class="icon-link"></a></td>' +
            '<td><a onclick="removeRow(this)" style="background-image:url(images/delete.gif);" type="button" class="icon-link"></a></td>' +
            '</tr>');
    }
...
function submitForm() {
    if (doValidationPolicyNameOnly()) {
        document.dataForm.action = "update-rule.jsp?nextPage=finish&ruleId=&ruleElementOrder="
                + orderRuleElement();
            ...
            <script type="text/javascript">
                function createNextRuleTargetRow() {
                    ...
                    jQuery('#multipleRuleTargetTable > tbody:last').append('<tr><td style="padding-left:0px !important;padding-right:0px !important"><select id="ruleTargetCategory_'  + index + '" name="ruleTargetCategory_'  + index + '" class="leftCol-small"> <%for (String category : categories) { if(currentRuleTargetCategory != null && category.equals(currentRuleTargetCategory)){%> <option value="<%=category%>" selected="selected"><%=category%> </option> <%} else {%> <option value="<%=category%>"><%=category%> </option> <%} }%></select></td>' +
                        ...
                        '<td><a title="Select Resources Names" class="icon-link" onclick="selectAttributesForRuleTarget(' + index + ');" style="background-image:url(images/registry.gif);"></a></td>' +
                        '<td style="padding-left:0px !important;padding-right:0px !important"><select id="ruleTargetCombineFunctions_'  + index + '" name="ruleTargetCombineFunctions_'  + index + '" class="leftCol-small" onchange="createNewTargetRow(this.options[this.selectedIndex].value)"><%for (String combineFunction : combineFunctions) {if (currentRuleTargetCombineFunction != null && combineFunction.equals(currentRuleTargetCombineFunction)) {%><option value="<%=combineFunction%>" selected="selected"><%=combineFunction%></option><%} else {%><option value="<%=combineFunction%>"><%=combineFunction%></option><%}}%></select></td>' +
                        '<td><a onclick="removeRow(this)" style="background-image:url(images/delete.gif);" type="button" class="icon-link"></a></td>' +
                        '<td><input type="hidden" name="ruleTargetAttributeId_'  + index +  '" id="ruleTargetAttributeId_'  + index + '" value="<%=currentRuleTargetAttributeId%>"/></td>' +
                        '<td><input type="hidden" name="ruleTargetAttributeTypes_'  + index + '" id="ruleTargetAttributeTypes_'  + index +  '" value="<%=currentRuleTargetAttributeDataType%>"/></td>' +
                        '</tr>');
...
%>
                     ...
                     <tr>
                        <td colspan="5"><fmt:message key="rule.obligation"/></td>
                    </tr>
                    <tr>
                        <td>
    ...
    <div class="toggle_container" id="newObligationLinkRow">
        <table id="obligationTable" name="obligationTable" class="normal"
            ...
            <tr>
                ...
                <td style="padding-left:0px !important;padding-right:0px !important">
                    <select id="obligationEffect_0" name="obligationEffect_0" class="leftCol-small">
                        <%
                            if (ruleEffects != null) {
                                for (String effect : ruleEffects) {
...
<tr>
    <td colspan="2" style="margin-top:10px;">
    <h2 class="trigger  <%if(extendAttributeDTOs == null){%>active<%} %>"><a href="#"><fmt:message
            key="add.extend.attribute"/></a></h2>
    <div class="toggle_container" id="newExtendLinkRow">
        <table id="extendAttributeTable" name="extendAttributeTable" class="normal"
           style="padding-left:0px !important">
            <tr>
                <td style="padding-left:0px !important;padding-right:0px !important">
                    <%
                        if (currentDynamicId != null && currentDynamicId.trim().length() > 0) {

                    %>
                    <input  name="dynamicId_0"  id="dynamicId_0" value="<%=currentDynamicId%>" />
                    <%
                    } else {
                    %>
                    <input  name="dynamicId_0" id="dynamicId_0" />
                    <%
                        }
                    %>
                </td>
                ...
                <td style="padding-left:0px !important;padding-right:0px !important">
                    <select id="dynamicSelector_0" name="dynamicSelector_0"
                            onchange="selectRightList(this.options[this.selectedIndex].value, 0)" class="leftCol-small">
                        <%
                            for (String selector : dynamicSelectors) {
                                if (currentDynamicSelector != null && selector.equals(currentDynamicSelector)) {
                        %>
                ...
                <%--<td style="padding-left:0px !important;padding-right:0px !important">--%>
                    <%--<select id="dynamicFunction_0" name="dynamicFunction_0"--%>
                            <%--class="leftCol-small">--%>
                        <%--<%--%>
                            <%--for (String ruleFunction : ruleFunctions) {--%>
                                <%--if (currentDynamicFunction != null && ruleFunction.equals(currentDynamicFunction)) {--%>
                        <%--%>--%>
                                <%--<option value="<%=ruleFunction%>" selected="selected"><%=ruleFunction%></option>--%>
                        <%--<%--%>
                                <%--}--%>
                ...
                <td style="padding-left:0px !important;padding-right:0px !important">
                    <select id="dynamicCategory_0" name="dynamicCategory_0"
                            class="leftCol-small">
                        <%
                            for (String category : categories) {
                                if (currentDynamicCategory != null && category.equals(currentDynamicFunction)) {
                        %>
                                <option value="<%=category%>" selected="selected"><%=category%></option>
                        <%
                                }
                ...
                <td id='dynamicFunctionAttributeValue_0' style="padding-left:0px !important;padding-right:0px !important">
                    <%
                        if (currentDynamicAttributeValue != null && currentDynamicAttributeValue.trim().length() > 0) {
                    %>
                    <input type="text" size="60" name="dynamicAttributeValue_0"
                           id="dynamicAttributeValue_0"
                           value="<%=currentDynamicAttributeValue%>" class="text-box-big"/>
                    <%
                        } else {
                    %>
                    <input type="text" size="60" name="dynamicAttributeValue_0"
                ...
                <td>
                    <input type="hidden" name="dynamicAttributeId_0"
                           id="dynamicAttributeId_0" value="<%=currentDynamicAttributeId%>"/>
                </td>
                <td>
                    <input type="hidden" name="dynamicAttributeTypes_0" id="dynamicAttributeTypes_0"
                           value="<%=currentDynamicAttributeDataType%>"/>
                </td>
            </tr>
        </table>
    </div>
